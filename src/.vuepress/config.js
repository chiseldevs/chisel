            ...
            '/': {
                ...
                nav: [
                    ...
                    },
                    {
                        ...
                        text: 'Issues',
                        link: 'https://github.com/genestatic/chisel/issues', target: '_self'
                    },
                    {
                        text: 'Links',
                        ...
                        items: [
                            {
                                text: 'Telegram', items: [
                                    {text: 'Community', link: 'tg://resolve?domain=chiseldevs', target: '_blank'},
                                    {text: 'News', link: 'tg://resolve?domain=genestatic', target: '_blank'},
                                    {text: 'Contact', link: 'tg://resolve?domain=genemator_bot', target: '_blank'},
                                ]
                            },
                            {
                                text: 'Devs', items: [
                                    {text: 'Group', link: 'https://t.me/chiseldevs', target: '_blank'},
                                    {text: 'GitHub', link: 'https://github.com/genestatic', target: '_blank'}
                                ]
                            },
                        ]
                    },
